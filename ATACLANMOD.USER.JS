// ==UserScript==
// @name         Legend mod v0.3 (OGARio v3)
// @namespace    ogario.v2
// @version      0.3
// @description  OGARio - Legend mod v0.3
// @homepage     http://www.legendmod.ml
// @author       szymy and Legend (mod only)
// @icon         http://legendclan.000webhostapp.com/legendmodpic.png
// @match        http://agar.io/*
// @updateURL    https://raw.githubusercontent.com/legendclan/mod/master/legendmod.user.js
...
//document.getElementById("import-settings").value="jim";
    ...
    $("#menu-footer").text("");
    // LEGEND footer
    $("#menu-footer").prepend('<span style="float: left; font-size: 13px;"><a target="_blank" onclick="ga(\'send\', \'event\', \'Link\', \'click\', \'legendWebsite\');" href="http://legendmod.000webhostapp.com/" style="color: #ffffff;" data-toggle="tooltip" data-title="Legend Mod Website" data-placement="left">Legend mod v' + modVersion + '</a></span>' +
    ...
    $("#leaderboard-hud > h4").text("Legend-mod");
    ...
    $("#LEGENDAds").load("https://raw.githubusercontent.com/legendclan/mod/master/.banner");
    }
    else{
	$("#LEGENDAds").load("https://raw.githubusercontent.com/legendclan/mod/master/.banner2");
    }
    // ANNOUNCEMENTS
    var nick1 = document.getElementById("nick").value;
    toastr["info"]('LEGEND mod v' + modVersion + ': Fixed Minor Ogario Sync Bugs!! Enjoy! :D');
    toastr["info"]('Hello ' + nick1 +'! </br>Legend Mod website: <a target="_blank" href="http://legendmod.000webhostapp.com/">LINK</a>');
